...
namespace dosbox_staging_vct
{
    internal class UserConf
    {
        ...
        */
        #endregion
        public string? SDL_fullscreen { get; set; }
        public string? SDL_display { get; set; }
        public string? SDL_fullresolution { get; set; }
        public string? SDL_windowresolution { get; set; }
        public string? SDL_window_position { get; set; }
        public string? SDL_window_decorations { get; set; }
        public string? SDL_transparency { get; set; }
        public string? SDL_host_rate { get; set; }
        public string? SDL_vsync { get; set; }
        public string? SDL_vsync_skip { get; set; }
        public string? SDL_presentation_mode { get; set; }
        public string? SDL_output { get; set; }
        public string? SDL_texture_renderer { get; set; }
        public string? SDL_waitonerror { get; set; }
        public string? SDL_priority { get; set; }
        public string? SDL_mute_when_inactive { get; set; }
        public string? SDL_pause_when_inactive { get; set; }
        public string? SDL_mapperfile { get; set; }
        public string? SDL_screensaver { get; set; }
        ...
        public string? DOSBOX_machine { get; set; }
        public string? DOSBOX_memsize { get; set; }
        public string? DOSBOX_mcb_fault_strategy { get; set; }
        public string? DOSBOX_vmemsize { get; set; }
        public string? DOSBOX_vmem_delay { get; set; }
        public string? DOSBOX_dos_rate { get; set; }
        public string? DOSBOX_vesa_modes { get; set; }
        public string? DOSBOX_vga_8dot_font { get; set; }
        public string? DOSBOX_vga_render_per_scanline { get; set; }
        public string? DOSBOX_speed_mods { get; set; }
        public string? DOSBOX_autoexec_section { get; set; }
        public string? DOSBOX_automount { get; set; }
        public string? DOSBOX_startup_verbosity { get; set; }
        public string? DOSBOX_allow_write_protected_files { get; set; }
        public string? DOSBOX_shell_config_shortcuts { get; set; }
        ...
        */
        #endregion
        public string? RENDER_aspect { get; set; }
        public string? RENDER_integer_scaling { get; set; }
        public string? RENDER_viewport { get; set; }
        public string? RENDER_monochrome_palette { get; set; }
        public string? RENDER_cga_colors { get; set; }
        public string? RENDER_glshader { get; set; }
        ...
        */
        #endregion
        public string? COMPOSITE_composite { get; set; }
        public string? COMPOSITE_era { get; set; }
        public string? COMPOSITE_hue { get; set; }
        public string? COMPOSITE_saturation { get; set; }
        public string? COMPOSITE_contrast { get; set; }
        public string? COMPOSITE_brightness { get; set; }
        public string? COMPOSITE_convergence { get; set; }
        ...
        */
         ...
         */
        #endregion
        public string? CAPTURE_capture_dir { get; set; }
        public string? CAPTURE_default_image_capture_formats { get; set; }
        ...
        */
        #endregion
        public string? MOUSE_mouse_capture { get; set; }
        public string? MOUSE_mouse_middle_release { get; set; }
        public string? MOUSE_mouse_multi_display_aware { get; set; }
        public string? MOUSE_mouse_sensitivity { get; set; }
        public string? MOUSE_mouse_raw_input { get; set; }
        public string? MOUSE_dos_mouse_driver { get; set; }
        public string? MOUSE_dos_mouse_immediate { get; set; }
        public string? MOUSE_ps2_mouse_model { get; set; }
        public string? MOUSE_com_mouse_model { get; set; }
        public string? MOUSE_vmware_mouse { get; set; }
        public string? MOUSE_virtualbox_mouse { get; set; }
        ...
        */
        #endregion
        public string? MIXER_nosound { get; set; }
        public string? MIXER_rate { get; set; }
        public string? MIXER_blocksize { get; set; }
        public string? MIXER_prebuffer { get; set; }
        public string? MIXER_negotiate { get; set; }
        public string? MIXER_compressor { get; set; }
        public string? MIXER_crossfeed { get; set; }
        public string? MIXER_reverb { get; set; }
        public string? MIXER_chorus { get; set; }
        ...
        */
        #endregion
        public string? MIDI_mididevice { get; set; }
        public string? MIDI_midiconfig { get; set; }
        public string? MIDI_mpu401 { get; set; }
        public string? MIDI_raw_midi_output { get; set; }
        ...
        */
        #endregion
        public string? FLUIDSYNTH_soundfont { get; set; }
        public string? FLUIDSYNTH_fsynth_chorus { get; set; }
        public string? FLUIDSYNTH_fsynth_reverb { get; set; }
        public string? FLUIDSYNTH_fsynth_filter { get; set; }
        ...
        */
        #endregion
        public string? MT32_model { get; set; }
        public string? MT32_romdir { get; set; }
        public string? MT32_mt32_filter { get; set; }
        ...
        */
        #endregion
        public string? SBLASTER_sbtype { get; set; }
        public string? SBLASTER_sbbase { get; set; }
        public string? SBLASTER_irq { get; set; }
        public string? SBLASTER_dma { get; set; }
        public string? SBLASTER_hdma { get; set; }
        public string? SBLASTER_sbmixer { get; set; }
        public string? SBLASTER_sbwarmup { get; set; }
        public string? SBLASTER_oplmode { get; set; }
        public string? SBLASTER_opl_fadeout { get; set; }
        public string? SBLASTER_sb_filter { get; set; }
        public string? SBLASTER_sb_filter_always_on { get; set; }
        public string? SBLASTER_opl_filter { get; set; }
        public string? SBLASTER_cms_filter { get; set; }
        ...
        */
        #endregion
        public string? IMFC_imfc { get; set; }
        public string? IMFC_imfc_base { get; set; }
        public string? IMFC_imfc_irq { get; set; }
        public string? IMFC_imfc_filter { get; set; }
        ...
        */
        #endregion
        public string? INNOVATION_sidmodel { get; set; }
        public string? INNOVATION_sidclock { get; set; }
        public string? INNOVATION_sidport { get; set; }
        public string? INNOVATION_6581filter { get; set; }
        public string? INNOVATION_8580filter { get; set; }
        public string? INNOVATION_innovation_filter { get; set; }
        ...
        */
        #endregion
        public string? SPEAKER_pcspeaker { get; set; }
        public string? SPEAKER_pcspeaker_filter { get; set; }
        public string? SPEAKER_tandy { get; set; }
        public string? SPEAKER_tandy_fadeout { get; set; }
        public string? SPEAKER_tandy_filter { get; set; }
        public string? SPEAKER_tandy_dac_filter { get; set; }
        public string? SPEAKER_lpt_dac { get; set; }
        public string? SPEAKER_lpt_dac_filter { get; set; }
        public string? SPEAKER_ps1audio { get; set; }
        public string? SPEAKER_ps1audio_filter { get; set; }
        public string? SPEAKER_ps1audio_dac_filter { get; set; }
        ...
        */
        #endregion
        public string? REELMAGIC_reelmagic { get; set; } 
        public string? REELMAGIC_reelmagic_key { get; set; }
        public string? REELMAGIC_reelmagic_fcode { get; set; }
        ...
        */
        #endregion
        public string? JOYSTICK_joysticktype { get; set; }
        public string? JOYSTICK_timed { get; set; }
        public string? JOYSTICK_autofire { get; set; }
        public string? JOYSTICK_swap34 { get; set; }
        public string? JOYSTICK_buttonwrap { get; set; }
        public string? JOYSTICK_circularinput { get; set; }
        public string? JOYSTICK_deadzone { get; set; }
        public string? JOYSTICK_use_joy_calibration_hotkeys { get; set; }
        public string? JOYSTICK_joy_x_calibration { get; set; }
        public string? JOYSTICK_joy_y_calibration { get; set; }
        ...
        */
        #endregion
        public string? SERIAL_serial1 { get; set; }
        public string? SERIAL_serial2 { get; set; }
        public string? SERIAL_serial3 { get; set; }
        public string? SERIAL_serial4 { get; set; }
        public string? SERIAL_phonebookfile { get; set; }
        ...
        */
        #endregion
        public string? DOS_xms { get; set; }
        public string? DOS_ems { get; set; }
        public string? DOS_umb { get; set; }
        public string? DOS_ver { get; set; }
        public string? DOS_locale_period { get; set; }
        public string? DOS_country { get; set; }
        public string? DOS_keyboardlayout { get; set; }
        public string? DOS_expand_shell_variable { get; set; }
        public string? DOS_shell_history_file { get; set; }
        public string? DOS_setver_table_file { get; set; }
        public string? DOS_pcjr_memory_config { get; set; }
        ...
        */
        #endregion
        public string? ETHERNET_ne2000 {  get; set; }
        public string? ETHERNET_nicbase { get; set; }
        public string? ETHERNET_nicirq { get; set; }
        public string? ETHERNET_macaddr { get; set; }
